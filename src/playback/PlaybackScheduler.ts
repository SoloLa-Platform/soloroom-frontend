...
export default class PlaybackScheduler {
  ...
  private schedulerIntervalHandle: number = 0;
  ...
  public setIterationStep(step: number) {
  ...
  public reset() {
    ...
    this.schedulerIntervalHandle = 0;
  }

  public loadNotes(currentVoiceEntries: VoiceEntry[]) {
